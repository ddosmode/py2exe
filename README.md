# py2exe — локализованная русскоязычная версия

> Этот репозиторий является **локализованной русскоязычной версией** [оригинального py2exe](https://github.com/py2exe/py2exe).
> Все docstrings, комментарии и документация переведены на русский язык.
> Оригинальный проект: https://github.com/py2exe/py2exe
